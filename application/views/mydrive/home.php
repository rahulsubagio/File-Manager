...
<div class="container-fluid">
  ...
  <div class="dropdown">
    <h5 class="dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown">
      <a href="#" class="text-decoration-none text-secondary">My Drive </a>
    </h5>
    <div class="dropdown-menu shadow-sm" aria-labelledby="dropdownMenuLink">
      <a class="dropdown-item font-weight-bold text-secondary" href="" data-toggle="modal" data-target="#folder">
        <i class="fas fa-folder-plus mr-3"></i>New Folder
      </a>
  ...
  <?php if ($file == null && $folder_path == null) : ?>
  ...
  <!-- jika folder ada -->
  <?php if ($folder_path != null) : ?>
    <h6 class="font-weight-bold ml-3 my-3">Folder</h6>
    <div class="card-deck">
      <?php foreach ($folder_path as $folder) : ?>
        <div class="row ml-2 mt-1 mb-3">
          <a href="<?= base_url('mydrive/inFolder/' . $folder['id_folder']) ?>" class="text-decoration-none">
            <div class="card shadow-sm" style="width: 15rem;">
              <div class="card-body p-3">
                <?php $text1 = $folder['folder_name']; ?>
                <?php if (strlen($text1) > 20) { ?>
                  <p class="card-text text-secondary" data-toggle="tooltip" title="<?= $text1 ?>">
                    <i class="fas fa-folder fa-lg mr-2"></i><?= substr($text1, 0, 20) . ' ...'; ?>
                  </p>
                <?php } else { ?>
                  <p class="card-text text-secondary">
                    <i class="fas fa-folder fa-lg mr-2"></i><?= $text1; ?>
                  </p>
                <?php } ?>
              </div>
            </div>
